...
function CardProyect({
  ...
  return (
    <div
      className={className ? "card" : "style-card-modal"}
    ...
    >
      ...
      <div className="card-footer">
        <Link
          href={hrefGit}
          className={`link-proyect ${displayLinkGit ? "" : "d-none"}`}
          icon={iconGit}
          ariaLabelGit={ariaLabelGit}
        />
        <Link
          href={hrefWeb}
          className={`link-proyect ${displayWeb ? "" : "d-none"}`}
          icon={iconWeb}
          ariaLabelWeb={ariaLabelWeb}
        />
      </div>
    </div>
  );
